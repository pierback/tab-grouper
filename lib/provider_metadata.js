...
const FRIENDLY_ERROR_MESSAGES_BY_KIND = {
  "missing-native-permission": "Native Messaging permission is missing. Save this provider or grant permission.",
  "native-host-not-found": "Native bridge is not installed. Run npm run native:install.",
...
export function getFriendlyProviderErrorMessage(error) {
  return FRIENDLY_ERROR_MESSAGES_BY_KIND[error?.providerErrorKind] ||
    error?.message ||
